...
class Block(nn.Module):
    ...
    def forward(self, x, scale_shift=None):
        ...
        # Scale and shift are used to mod   ulate the output. This is a variant
...
class Unet(nn.Module):
    ...
    def cfg_forward(self, x, time, model_kwargs={}):
        ...
        # Unconditional prediction (drop condition)
        ...
        x = (cfg_scale + 1.0) * cond_out - cfg_scale * uncond_out
        ##################################################################
